...
function CopilotButton() {
  ...
  return (
    <button
      ...
      className="flex fixed items-center gap-1.5 px-2 border border-gold/20 rounded text-head hover:border-gold hover:ring-1 hover:ring-gold/50 hover:bg-gold/10 transition-all z-50 group cursor-pointer"
      style={{ 
        bottom: '16px', 
        right: '16px',
        height: '32px',
