...
function Navbar() {
  ...
  // Social links (used at top of navbar)
  const socialLinks = [
    { href: 'https://github.com/kuldeepsinhjhala', label: 'GitHub', icon: (
    ...
    { href: 'https://instagram.com/kuldeepsinhjhala', label: 'Instagram', icon: (
    ...
    { href: 'mailto:kuldeepsinhjhala@example.com', label: 'Email', icon: (
  ...
  const SocialIconsBlock = () => (
    <div className="flex flex-nowrap justify-evenly items-center w-full min-w-0 px-0">
      {socialLinks.map((link) => (
        <a
          ...
          className="flex-shrink-0 flex items-center justify-center text-body hover:text-gold transition-colors"
  ...
  return (
    <>
      ...
      <nav ref={navRef} className="hidden md:block bg-card border-r border-gold/20 w-auto min-w-fit h-screen fixed left-0 top-0 flex flex-col overflow-hidden">
        ...
        <div className="px-4 py-0 flex-shrink-0 pt-2 pb-0 ">
          <div className="flex items-center gap-2">
            ...
            />
            <h2 className="text-head text-xl font-semibold uppercase tracking-wider">
              Explorer
            </h2>
          </div>
        </div>
        ...
        <div className="p-3 flex-1 overflow-y-auto min-h-0">
          {/* Social icons - top/bottom lines full width (match TabBar border-gold/10), -mx-3 -mt-3 so lines touch edges and top aligns */}
          <div className="border-t border-b border-gold/10 -mx-3 -mt-0.5 px-3 pt-3 pb-2 mb-4">
            <SocialIconsBlock />
          </div>
          {/* Folder + kuldeepsinhjhala.com below icons */}
      ...
      >
        ...
        <div className="p-3 flex-1 overflow-y-auto min-h-0">
          {/* Social icons - top/bottom lines full width (match TabBar border-gold/10), -mx-3 -mt-3 so lines touch edges and top aligns */}
          <div className="border-t border-b border-gold/10 -mx-3 -mt-3 px-3 pt-3 pb-3 mb-4">
            <SocialIconsBlock />
          </div>
          {/* Folder + kuldeepsinhjhala.com below icons */}
          <div className="flex items-center text-head text-sm font-medium mb-1 px-2 py-1 rounded hover:bg-card/50 transition-colors">
