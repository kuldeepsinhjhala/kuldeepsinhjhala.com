...
function SearchBar() {
  ...
  const socialMediaAccounts = [
    {
      ...
      url: 'https://github.com/kuldeepsinhjhala',
      icon: (
    ...
    },
    {
      ...
      name: 'LinkedIn',
      username: 'kuldeepsinhjhala',
      url: 'https://linkedin.com/in/kuldeepsinhjhala',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      id: 3,
      name: 'Twitter',
      username: 'kuldepsinhjhala',
      url: 'https://twitter.com/kuldepsinhjhala',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      name: 'Medium',
      username: '@kuldeepsinhjhala',
      url: 'https://medium.com/@kuldeepsinhjhala',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      name: 'Instagram',
      username: 'kuldeepsinhjhala',
      url: 'https://instagram.com/kuldeepsinhjhala',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      id: 6,
      name: 'Email',
      username: 'kuldeepsinhjhala@example.com',
      url: 'mailto:kuldeepsinhjhala@example.com',
      icon: (
  ...
  const contactOptions = [
    ...
    },
    {
      id: 2,
      type: 'Email',
      value: 'kuldeepsinhjhala@example.com',
      url: 'mailto:kuldeepsinhjhala@example.com',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      ...
      <div className="flex items-center h-full w-full max-[425px]:w-full gap-2">
        ...
        <button
          onClick={() => {
            // Add download resume functionality here
            console.log('Download Resume clicked')
            // You can add actual download logic here, e.g.:
        ...
        >
          ...
          <span className="hidden min-[425px]:inline">Download Resume</span>
        </button>
      </div>
